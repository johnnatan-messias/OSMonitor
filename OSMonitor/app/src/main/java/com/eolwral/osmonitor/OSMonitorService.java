...
public class OSMonitorService extends Service implements ipcClientListener {
    private String pathFile = Environment.getExternalStorageDirectory().getPath() + File.separator + "OSMonitor/";
    ...
    public void onCreate() {
        ...
        file.mkdirs();
        try {
            outFile = new PrintWriter(new File(file.getPath() + "OSMonitorLog.txt"));
    ...
    private void saveFile() {
        outFile.write("cpu: " + UserInterfaceUtil.convertToUsage(cpuUsage) + "\n");
        outFile.flush();
    }
    ...
    private void refreshNotification() {
        ...
        Log.i("JOHN", String.valueOf(cpuUsage));
        switch (notificationType) {
